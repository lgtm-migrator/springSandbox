...
java -Xms128m -Xmx192m -jar -Dspring.profiles.active=local,peer1 ./spring-ms-countries/target/spring-ms-countries-20.08.jar &
java -Xms128m -Xmx192m -jar -Dspring.profiles.active=local,peer2 ./spring-ms-countries/target/spring-ms-countries-20.08.jar &
